...
list.of.packages <- c("tidyverse", "tsibble", "latex2exp", "fpp3", "tseries", "fable", "gridExtra", "MASS", "patchwork")
...
lm_present_forecast <- forecast(lm_present_fit, h=276)
forecast::accuracy(lm_present_forecast, test_data)
```
...
arima_present_forecast <- forecast(arima_present_fit, h=276)
forecast::accuracy(arima_present_forecast, test_data)
```
